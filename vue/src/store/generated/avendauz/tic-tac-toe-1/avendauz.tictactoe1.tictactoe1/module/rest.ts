 ...
 */
export interface Tictactoe1QueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: Tictactoe1Params;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<Tictactoe1QueryParamsResponse, RpcStatus>({
      path: `/avendauz/tictactoe1/tictactoe1/params`,
      method: "GET",
      format: "json",
      ...params,
    });
